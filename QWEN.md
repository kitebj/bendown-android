...
| 2026-04-01 | 完成剪贴板自动保存 | 使用onWindowFocusChanged检测（Android 10+限制onResume读取为null） |
| 2026-04-01 | 完成来源记录 | 优先获取App名称，获取失败时根据Intent类型判断（分享/外部打开） |
| 2026-04-01 | 长按菜单定位 | 使用Box+offset直接定位像素值，避免dp转换问题 |
